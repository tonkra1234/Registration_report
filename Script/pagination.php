<div id=paginate>
    ...
    <div class="d-flex justify-content-end">
        <nav aria-label="Page navigation example">
            ...
            <ul class="pagination">
                <?php if ($page_no > 1): ?>
                <li class="prev page-item"><a href="?page_no=<?php echo $page_no-1 ?>&month_year=<?php echo $month_year;?>"
                        class="page-link">Prev</a></li>
                <?php endif; ?>

                <?php if ($page_no > 3): ?>
                <li class="start page-item"><a href="?page_no=1&month_year=<?php echo $month_year;?>"
                        class="page-link">1</a></li>
                        <li class="dots page-item"><a class="page-link" href="#">...</a></li>
                <?php endif; ?>

                <?php if ($page_no-2 > 0): ?><li class="page page-item"><a class="page-link"
                        href="?page_no=<?php echo $page_no-2 ?>&month_year=<?php echo $month_year;?>"><?php echo $page_no-2 ?></a>
                </li><?php endif; ?>
                <?php if ($page_no-1 > 0): ?><li class="page page-item"><a class="page-link"
                        href="?page_no=<?php echo $page_no-1 ?>&month_year=<?php echo $month_year;?>"><?php echo $page_no-1 ?></a>
                </li><?php endif; ?>
                ...
                <li class="end page-item"><a class="page-link"
                        href="?page_no=<?php echo ceil($total_records / $total_records_per_page) ?>&month_year=<?php echo $month_year;?>"><?php echo ceil($total_records / $total_records_per_page) ?></a>
                </li>
                <?php endif; ?>

                <?php if ($page_no < ceil($total_records / $total_records_per_page)): ?>
                <li class="next page-item"><a class="page-link"
                        href="?page_no=<?php echo $page_no+1 ?>&month_year=<?php echo $month_year;?>">Next</a></li>
                <?php endif; ?>
            </ul>
            <?php endif; ?>
        </nav>
