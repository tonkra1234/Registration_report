        ...
        <div class="container-fluid p-5">
            <form class="my-lg-3 my-2 shadow p-lg-3 p-2" action="" method="GET" accept-charset="utf-8">
                <div class="row">
                    ...
                    <div class="col-sm-2 col-12 d-grid">
                        <a class="btn btn-danger px-5 ms-1" role="button" href="./medical_abr_table.php">Clear all</a>
                    </div>
                </div>
            </form>
            <div class="card shadow">
                <div class="card-header d-flex justify-content-between">
                    <div class="my-1">
                        <h4 class="pt-1" style="color: #326292 ;">Table of ABR medical device</h4>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
        if ($result_medical_abr->num_rows > 0){
            while ($row_medical_abr = mysqli_fetch_array($result_medical_abr)){
        ?>
                            <tr>
                                ...
                                <?php else : ?>
                                <span
                                    class="badge bg-warning text-dark"><?php echo (array_key_exists("Show_status",$row_medical_abr)) ? $row_medical_abr["Show_status"] : "" ; ?></span>
                                </td>
                                <?php endif; ?></td>
                                <td class="text-center"><a type="button" class="btn btn-primary"
                                        href="./detail.php?id=<?php echo $row_medical_abr["id"];?>&type=medical_abr">Click</a>
                                </td>
                                <td class="text-center"><a type="button" class="btn btn-success"
                                        href="./report_show.php?id=<?php echo $row_medical_abr["id"];?>&type=medical_abr">Click</a>
                                </td>
                            </tr>
                            <?php
            $i++;
