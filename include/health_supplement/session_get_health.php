...
$Applicant_Details = $_SESSION['Applicant_Details'];
$_SESSION['Applicant_Details'] = $Applicant_Details;

$Category = $_SESSION['Category'];
$_SESSION['Category'] = $Category;

$Manufacturer_Details = $_SESSION['Manufacturer_Details'];
$_SESSION['Manufacturer_Details'] = $Manufacturer_Details;

$Label_Claim = $_SESSION['Label_Claim'];
$_SESSION['Label_Claim'] = $Label_Claim;

$Title_Evidence = $_SESSION['Title_Evidence'];
...
$Verification_Evidence = $_SESSION['Verification_Evidence'];
$_SESSION['Verification_Evidence'] = $Verification_Evidence;

$URL = $_SESSION['URL'];
$_SESSION['URL'] = $URL;

$evidence_support_label = $_SESSION['evidence_support_label'];
